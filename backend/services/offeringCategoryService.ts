import {
  createOfferingCategoryModel,
  deleteOfferingCategoryModel,
  getAllOfferingCategoryModel,
  getOfferingCategoryBySlugModel,
  getSIngleOfferingCategoryModel,
  UpdateOfferingCategoryModel,
  updateOfferingCategoryStatusModel,
} from "../models/offeringCategoryModel";
import {
...
export async function updateOfferingCategoryService(
  ...
  try {
    ...
    const duplicateCategory = await getOfferingCategoryBySlugModel(
      category.slug,
    );
