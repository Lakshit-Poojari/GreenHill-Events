...
const WellcomeToGrennHill = () => {
  return (
    <>
      <div className=" bg-[#1a1919] mx-2 px-3 sm:mx-6 sm:px-4 md:mx-10 md:px-6 lg:mx-12.25 lg:px-4.75 pt-10 pb-20 sm:pt-15 md:pt-25 lg:pt-55">
        <div className="text-center  ">
          ...
          <hr className="w-20 sm:w-[18%] mx-auto mt-2 border-2 rounded-2xl border-[rgba(201,172,140,1)] " />
        </div>

        <div className="text-center font-['Old_Standard_TT'] text-[rgba(201,172,140,1)] italic mt-10 text-[1.2rem]">
