    ...
    <div className="max-w-4xl mx-auto px-8 py-12 text-white">
      ...
      <form className="mt-6 space-y-8">
        ...
        <div>
          ...
          <input
            type="text"
            className="w-full h-10 bg-[#E8E8E8] text-black px-4 outline-none"
          />
        </div>
        {/* Email */}
        <div>
        ...
        {/* Phone */}
        <div>
          <label className="block text-lg font-bold mb-3">Phone</label>
          <input
            type="tel"
            className="w-full h-10 bg-[#E8E8E8] text-black px-4 outline-none"
          />
        ...
        <div>
          ...
          <textarea
            rows={8}
            className="w-full bg-[#E8E8E8] text-black p-4 outline-none resize-none"
          />
        </div>
        {/* Submit Button */}
        <button
          type="submit"
          className="bg-[#333] text-white px-10 py-4 rounded-full text-xl font-medium 
