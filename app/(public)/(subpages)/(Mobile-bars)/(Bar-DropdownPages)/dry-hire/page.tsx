...
const page = () => {
  return (
    <>
      <div className="mx-4 pt-26 sm:mx-6 md:mx-10 lg:mx-16 xl:mx-16.25 text-[#C9AC8C] italic font-['Old_Standard_TT']">
        ...
        <div className="py-6">
          <div className="text-[20.4px] items-start italic text-justify space-y-1.5 my-6 py-3 font-['Old_Standard_TT']">
            <p>
              ...
              already have a bar team, to compliment an existing bar, provide
              additional refrigeration facilities, for caterers providing
              drinks, or for those who simply wish to throw their own party and
              provide the drink. We have also worked with various brands who
              wish to wrap our horse box with their branding and serve their
              products.
            </p>
