    ...
    <>
      <div className="pt-26 mx-16.25 px-6.75 text-[#C9AC8C] text-lg items-start italic text-justify space-y-1.5 my-6 py-3 
        ...
        <div>
          <div>
            <p>
              We attend your event with our experienced team of bar staff and a
              full range of mouth-watering drinks designed by us or chosen by
              you.
              <br />
              We are personal license holders, we will formally take care of the
              TENS application if one is required.
              <br />
              Cash and payments are taken. We use izettle or sumup.
              <br />
              A hire fee (from £250) is payable with an agreed minimum spend.
              <br />A cash bar is a very simple option. Your guests simply pay
              for their own drinks (wines, beers, spirits, soft drinks) by cash
              or by card.
            </p>
          </div>
          <div>
            ...
            <Link href="/contact-us">
              <button
                className="mt-12 mb-5 text-[1.25rem] border border-[#C9AC8C] rounded-4xl px-10 py-3 text-[#C9AC8C]
                        animate-[bounce-x_0.49s_ease-in-out_infinite] hover:bg-[#C9AC8C] hover:text-black transition 
                        duration-300"
              >
                ENQUIRE TODAY
              </button>
