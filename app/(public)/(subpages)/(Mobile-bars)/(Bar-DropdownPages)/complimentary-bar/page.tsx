...
export const metadata: Metadata = {
  title: "Complimentary Bar - GreenHillEvent",
  // description: "",     ###############################################################
  icons: {
    icon: "/faviconV2.png",
...
const page = () => {
  return (
    <>
      <div
        className="mx-4 pt-26 sm:mx-6 md:mx-10 lg:mx-16 xl:mx-16.25 text-[#C9AC8C] text-[20.4px] items-start c text-justify space-y-1.5 my-6 py-3 
