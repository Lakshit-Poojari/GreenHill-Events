    ...
    <>
        <div className="pt-26 mx-16.25 px-6.75 text-[#C9AC8C] text-lg items-start italic text-justify space-y-1.5 my-6 py-3 font-['Old Standard TT']">
            ...
            <div>
              ...
              <div>
                <p>On any of the above options if there is an agreed spend and it runs out, we make it a cash bar for guests or agree to extend the tab. Simples!<br/>
                  We attend your event and run a ‘tab’ for hosts who would like to entertain their guests with complimentary drinks of their choice.<br/>
                  Our POS software allows us to track all drinks in real time to give the host a breakdown of everything that was spent, on what and when.<br/>
                  A hire fee is payable (from £250) with an agreed minimum spend.</p>
              </div>
              <div>
