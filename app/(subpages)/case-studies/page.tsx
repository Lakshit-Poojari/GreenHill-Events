...
const blogs = [
  {
    ...
    description:"The Brief The International Cotton Association would like suggestions for entertainment for their gala dinner to cel ...",
  },
  {
    image:"/About/Case-studies/kia.jpg",
    title:"Kia Oval – Bar/entertainment",
    description:"Brief The Kia Oval, Surrey Cricket & Jolly Hog came to Greenhill Events as they were looking to create a food an ...",
  },
  {
    image:"/About/Case-studies/birthday.jpg",
    title:"Surprise Birthday – Event Management",
    description:"Like with many of our event management clients, we were charged with organising a surprise 40th summer birthday party f ...",
  },
  {
    image:"/About/Case-studies/costa.jpg",
    title:"Costa Smeralda event – Entertainment",
    description:"Hosted on June 26-27 2015 by one of Golf’s current superstars, Justin Rose, The Costa Smeralda Invitational prove ...",
  },
]
