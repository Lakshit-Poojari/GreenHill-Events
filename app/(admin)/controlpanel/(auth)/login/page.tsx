    ...
    <div className="flex h-screen items-center justify-center bg-[#101010] px-4">
      <div className="w-full max-w-md rounded-2xl border border-gray-700 bg-[#181616] p-8 shadow-2xl">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="h-12 w-full rounded-lg bg-[#C9AC8C] font-semibold text-black shadow-lg transition-all duration-300 
            hover:bg-[#b89671] hover:shadow-xl active:scale-[0.98]"
          >
            Login
          </button>
        </form>
