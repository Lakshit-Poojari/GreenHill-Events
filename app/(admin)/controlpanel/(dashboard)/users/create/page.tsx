      ...
      <div className="flex items-center justify-between">
        <div>
          <Link
            ...
            className="mb-2 inline-flex items-center gap-2 rounded-lg border border-gray-700 bg-[#181616] px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:border-[#C9AC8C] hover:text-[#C9AC8C]"
          >
            <ArrowLeft size={18} />
            Back to Users
          </Link>
