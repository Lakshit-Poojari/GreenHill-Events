...
const page = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome */}
      <div
        className="rounded-xl border border-gray-700 bg-[#181616] p-8 shadow-[0_8px_30px_rgba(0,0,0,0.5)] 
      ...
      {/* Quick Actions */}
      <div
        className="rounded-xl border border-gray-700 bg-[#181616] p-6 shadow-[0_8px_30px_rgba(0,0,0,0.5)] 
          transition-all duration-300 hover:shadow-[0_12px_35px_rgba(201,172,140,0.18)]"
      >
